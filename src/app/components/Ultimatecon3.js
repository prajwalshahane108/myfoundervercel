    ...
    >
      <Container className={classes.contentContainer}>
        ...
        >
          ...
          >
            <AnimatedWords
              text={`To transform entrepreneurial ${!isMobile ? "" : "\n"}`}
              className={`${classes.headingLine} ${classes.whiteText}`}
              delay={0.1}
              staggerChildren={0.03}
              highlightWords={["transform"]}
            />
          </MotionBox>
          ...
          >
            <AnimatedWords
              text={`vision into world-changing ${!isMobile ? "" : "\n"}`}
              className={`${classes.headingLine} ${classes.whiteText}`}
              delay={0.1}
              staggerChildren={0.03}
              highlightWords={["world-changing"]}
            />
          </MotionBox>
        ...
        >
          <AnimatedWords
            text="We're building Saudi Arabia's most dynamic innovation ecosystem—where ambitious founders connect with strategic investors and industry experts to create businesses that drive economic growth and shape the future."
            delay={0.2}
