...
function TestimonialsSection() {
  ...
  const featuredTestimonial = {
    ...
    company: "Zapfast",
    testimony:
      '"MyFounders.Club\'s fusion of global connections and local expertise set our expansion apart. Their cross-border solutions are second to none."',
  ...
  const cardTestimonials = [
    {
      ...
      rating: 5,
      testimony:
        '"The cross-border expertise from MyFounders.Club set a new benchmark for our international expansion. Highly recommended!"',
    ...
    },
    {
      ...
      rating: 5,
      testimony:
        '"MyFounders.Club\'s revolutionary approach and global connections elevated our fundraising journey. Stellar performance!"',
      personName: "Mohammed Al-Qassim",
    ...
    },
    {
      ...
      rating: 5,
      testimony:
        '"The blend of local knowledge and global reach at MyFounders.Club transformed our vision into reality. Exceptional support!"',
      personName: "Jessica Chen",
      personTitle: "Founder",
    },
  ];
