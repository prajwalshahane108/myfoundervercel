...
function FooterSection() {
  ...
  const navLinks = [
    ...
    { name: "Founders & Partners", id: "Members" },
    { name: "Why Saudi Arabia", id: "services" },
    { name: "FAQ", id: "contact" },
  ];
    ...
    <Box className={classes.boot}>
      ...
      >
        ...
        >
          ...
          >
            {/* Building the Future */}
            Together, we grow. Together, we innovate. Together, we achieve 
            <br />{" "}
            <span style={{ color: "#E87811" }}>Vision 2030.</span>
          </MotionTypography>
          ...
          >
            Whether you're a visionary founder ready to scale your business, an
            investor seeking high-potential opportunities, or an advisor eager
            to make an impact—
            <br />
            <br />
            Myfounders.Club: Where the Journey is Meaningful, the Connections
            are Powerful, and the Future is Yours to Build.
          </MotionTypography>
