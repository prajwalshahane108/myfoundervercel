  ...
  const mainServices = [
    {
      ...
      description:
        " Showcase your startup to investors across all our international chapters.",
      type: "plan",
    },
    {
      title: "Virtual Founders Roundtable",
      description:
        "Connect with peers facing similar challenges across different markets.",
      type: "code",
    },
    {
      title: "Cross-Border Advisory Hours",
      description:
        "Get guidance on international expansion from our global network of experts.",
      type: "automation",
    },
  ];
  ...
  return (
      <Box id="mission" ref={ref} className={classes.root}>
        ...
        <MotionTypography
          ...
          animate={controls}
        >
          Expertise That Drives Global Growth
        </MotionTypography>
        ...
        <MotionTypography
          ...
          animate={controls}
        >
          With deep cross-border expertise, we deliver quality connections that
          drive success and exceed international expansion goals.
        </MotionTypography>
